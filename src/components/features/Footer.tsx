          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex gap-4">
              <motion.a 
                ...
                href="https://www.instagram.com/oj_prints029"
                target="_blank"
              ...
              <motion.a 
                whileHover={{ scale: 1.1 }}
                className="h-10 w-10 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-primary hover:border-primary transition-all" 
                href="https://www.facebook.com/ojprints"
                target="_blank"
                rel="noopener noreferrer"
                title="Facebook"
              >
              ...
              <motion.a 
                whileHover={{ scale: 1.1 }}
                className="h-10 w-10 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-primary hover:border-primary transition-all" 
                href="https://www.tiktok.com/@ojprints029"
                target="_blank"
                rel="noopener noreferrer"
                title="TikTok"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:ojprints2676@gmail.com" className="hover:text-primary transition-colors">ojprints2676@gmail.com</a>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="https://wa.me/2349154300663" className="hover:text-primary transition-colors">+234 915 430 0663</a>
              </li>
            </ul>
          </div>
        </div>
